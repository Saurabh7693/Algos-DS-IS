...
class puzzle_test:
    ...
    def get_input(self):
        ...
        l = [[int(num) for num in raw_input("Initial state. Enter 3 numbers per line separated by a single space :").split()]]
        l.append([int(num) for num in raw_input("Next 3 numbers: ").split()])
        l.append([int(num) for num in raw_input("Last 3 numbers: ").split()])
